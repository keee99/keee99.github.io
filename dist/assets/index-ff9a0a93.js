...
`)a=0,l-=r;else{const h=zE(u,s,a,l,n);a+=h.offsetX,o.push(h.path)}}return o}function zE(t,e,n,i,s){const r=s.glyphs[t]||s.glyphs["?"];if(!r){console.error('THREE.Font: character "'+t+'" does not exists in font family '+s.familyName+".");return}const o=new DE;let a,l,c,u,h,d,p,g;if(r.o){const v=r._cachedOutline||(r._cachedOutline=r.o.split(" "));for(let m=0,f=v.length;m<f;)switch(v[m++]){case"m":a=v[m++]*e+n,l=v[m++]*e+i,o.moveTo(a,l);break;case"l":a=v[m++]*e+n,l=v[m++]*e+i,o.lineTo(a,l);break;case"q":c=v[m++]*e+n,u=v[m++]*e+i,h=v[m++]*e+n,d=v[m++]*e+i,o.quadraticCurveTo(h,d,c,u);break;case"b":c=v[m++]*e+n,u=v[m++]*e+i,h=v[m++]*e+n,d=v[m++]*e+i,p=v[m++]*e+n,g=v[m++]*e+i,o.bezierCurveTo(h,d,p,g,c,u);break}}return{offsetX:r.ha*e,path:o}}const Ep={uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
                ...
                `}),"baseTexture");s.needsSwap=!0;const r=new yd(this.renderer);return r.addPass(e),r.addPass(s),{bloomComposer:i,finalComposer:r}}recordMaterials(){this.scene.traverse(e=>{e.material&&this.materials.set(e.uuid,e.material)})}keys(e){return Object.keys(e)}}const XE={bg_color:0,ambientColor:1118515,ambientIntensity:.1,modelPath:"public/scene.gltf",text:"Jia Jun's",subtext:"Portfolio",textFontPath:"fonts/beon_medium.typeface.json",subtextFontPath:"fonts/bettina_signature_regular.typeface.json",textColor:16746598,subtextColor:16746666,borderColor:65280,textIntensity:.3,subtextIntensity:.3,textBorderIntensity:.2,borderPosOffset:.15,thickness:.025,flickerTolerance:.005,bloomThreshold:0,bloomStrength:2.5,bloomRadius:1},jE=Nn({__name:"BGScene",props:{homeY:{type:Number,required:!0},aboutY:{type:Number,required:!0},portfolioY:{type:Number,required:!0}},setup(t){const e=t,n=dt(null);return Ii(()=>{let i=n.value;if(!i)throw new Error("No canvas found");const s=new $E(i,XE,e);function r(){s.update(),setTimeout(function(){requestAnimationFrame(r)},1e3/60)}r()}),(i,s)=>(G(),ve("main",null,[W("div",null,[W("canvas",{ref_key:"bgscene",ref:n,class:"webgl"},null,512)])]))}});const Tp=t=>(Hr("data-v-77a1df73"),t=t(),Vr(),t),KE={key:0,class:"app-topbar"},qE={class:"topbar-start"},YE=Tp(()=>W("a",{class:"topbar-title neon-text-primary",href:"#home"},"Jj",-1)),ZE=["href"],JE={class:"topbar-text"},QE={class:"topbar-end"},eM=["href"],tM={class:"topbar-text"},nM=["href"],iM={key:1,class:"app-topbar"},sM=Tp(()=>W("div",{class:"topbar-start"},[W("a",{class:"topbar-title neon-text-primary",href:"/#home"},"Jj")],-1)),rM={class:"topbar-end"},oM={class:"sidebar-links"},aM=["href"],lM={class:"topbar-text"},cM={class:"sidebar-socials"},uM=["href"],hM=767,dM=Nn({__name:"Topbar",props:{active:{type:String,required:!0}},setup(t){const e=t,n=dt(["about","portfolio"]),i=dt([]),s=dt([{name:"github",link:"https://github.com/keee99"},{name:"linkedin",link:"https://www.linkedin.com/in/jayjaykoh/"},{name:"instagram",link:"https://www.instagram.com/jayjay_koh/"},{name:"envelope",link:"mailto:kohjim99@gmail.com"}]),r=dt(window.innerWidth),o=ng(e,"active"),a=dt(!1),l=u=>u.charAt(0).toUpperCase()+u.slice(1),c=()=>r.value=window.innerWidth;return window.addEventListener("resize",c),(u,h)=>{const d=vt("Sidebar");return G(),ve("main",null,[r.value>hM?(G(),ve("div",KE,[W("div",qE,[YE,(G(!0),ve(tt,null,Wt(n.value,p=>(G(),ve("a",{class:At(["topbar-link",{"topbar-link-active":o.value===p,"topbar-link-inactive":o.value!==p}]),href:"#"+p},[W("div",JE,Nt(l(p)),1)],10,ZE))),256))]),W("div",QE,[(G(!0),ve(tt,null,Wt(i.value,p=>(G(),ve("a",{class:At(["topbar-link",{"topbar-link-active":o.value===p,"topbar-link-inactive":o.value!==p}]),href:"#"+p},[W("div",tM,Nt(l(p)),1)],10,eM))),256)),(G(!0),ve(tt,null,Wt(s.value,p=>(G(),ve("a",{class:"topbar-link",href:p.link,target:"_blank"},[W("i",{class:At(["social-i pi","pi-"+p.name])},null,2)],8,nM))),256))])])):Oe("",!0),r.value<=768?(G(),ve("div",iM,[sM,W("div",rM,[Xe(d,{visible:a.value,"onUpdate:visible":h[1]||(h[1]=p=>a.value=p),position:"full",id:"app-sidebar",class:"neon-border"},{default:ht(()=>[W("div",oM,[(G(!0),ve(tt,null,Wt(n.value,p=>(G(),ve("a",{class:At(["topbar-link sidebar-col",{"topbar-link-active":o.value===p,"topbar-link-inactive":o.value!==p}]),href:"#"+p,onClick:h[0]||(h[0]=g=>a.value=!1)},[W("div",lM,Nt(l(p)),1)],10,aM))),256))]),W("div",cM,[(G(!0),ve(tt,null,Wt(s.value,p=>(G(),ve("a",{class:"topbar-link sidebar-col",href:p.link,target:"_blank"},[W("i",{class:At(["social-i pi","pi-"+p.name])},null,2)],8,uM))),256))])]),_:1},8,["visible"]),W("i",{class:"pi pi-bars topbar-hamburger neon-text-secondary",onClick:h[2]||(h[2]=p=>a.value=!0)})])])):Oe("",!0)])}}});const Xr=(t,e)=>{const n=t.__vccOpts||t;for(const[i,s]of e)n[i]=s;return n},fM=Xr(dM,[["__scopeId","data-v-77a1df73"]]);var pM=!1;/*!
  * pinia v2.1.3
  * (c) 2023 Eduardo San Martin Morote
  * @license MIT
