    ...
    <div class="app-topbar" v-if="screenWidth > screenThreshold">
      ...
      <div class="topbar-start">
        ...
        <a class="topbar-link"
          ...
          v-for="item in navStartItems" :href="'#' + item">
      ...
      <div class="topbar-end">
        <a class="topbar-link" :class="{
          'topbar-link-active': activeItem === item,
          'topbar-link-inactive': activeItem !== item
        }" v-for="item in navEndItems" :href="'#' + item">
          <div class="topbar-text">
            {{ capitalize(item) }}
          </div>
        </a>

        <a class="topbar-link" v-for="item in socials" :href='item.link' target="_blank">
        ...
        <Sidebar v-model:visible="sideBarVisible" position="full" id="app-sidebar" class="neon-border">
          ...
          <div class="sidebar-links">
            <a class="topbar-link sidebar-col"
              :class="{ 'topbar-link-active': activeItem === item, 'topbar-link-inactive': activeItem !== item }"
              v-for="item in navStartItems" :href="'#' + item" @click="sideBarVisible = false">
              <div class="topbar-text">
                {{ capitalize(item) }}
              </div>
            </a>
          ...
          <div class="sidebar-socials">
            <a class="topbar-link sidebar-col" v-for="item in socials" :href='item.link' target="_blank">
              <i class="social-i pi" :class="'pi-' + item.name"></i>
            </a>
          </div>
